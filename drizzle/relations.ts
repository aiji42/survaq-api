...
export const shopifyProductsRelation = relations(schema.shopifyProducts, ({ one, many }) => ({
...
export const shopifyVariantsRelation = relations(schema.shopifyVariants, ({ one, many }) => ({
...
export const shopifyCustomSKUsRelation = relations(schema.shopifyCustomSkUs, ({ one, many }) => ({
...
export const shopifyPageRelation = relations(schema.shopifyPages, ({ one }) => ({
  product: one(schema.shopifyProducts, {
